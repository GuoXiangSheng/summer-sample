...
CREATE TABLE `s_applogs` (
  ...
  `DataIn_` text,
  PRIMARY KEY (`UID_`)
) ENGINE=InnoDB AUTO_INCREMENT=3104237 DEFAULT CHARSET=utf8 COMMENT='服务调用记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=55359 DEFAULT CHARSET=utf8 COMMENT='在下用户表';
...
) ENGINE=InnoDB AUTO_INCREMENT=188502 DEFAULT CHARSET=utf8;
